...
def create_target(protests, regimes):
    ...
    for protest_index, protest_scode, protest_start in protests:
        ...
        for regime_index in regime_country_df.index:
            ...
            present = regime_country_df.loc[regime_index, "present"]
    ...
    working_df["days_until_next_regime_chg"] = (
        working_df["next_regime_chg_date"] - working_df["startdate"]
    ).dt.days
