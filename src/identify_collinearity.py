...
def calculate_collinearity(df, min_threshold=0.5, return_result=False, plot=True):
    ...
    df_corr = df_corr.sort_values(0, ascending=False)

    # zip the variable name columns (Which were only named level_0
    # and level_1 by default) in a new column named "pairs"
    ...
    # drop duplicates. This could be dangerous if you have variables
    # perfectly correlated with variables other than themselves.
